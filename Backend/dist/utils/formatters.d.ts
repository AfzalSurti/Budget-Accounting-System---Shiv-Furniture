...
export declare const mapDocStatusToBadge: (status: "draft" | "posted" | "cancelled", paymentState?: string | null) => "failed" | "completed" | "warning" | "pending";
...
export declare const formatBadgeLabel: (value: string) => string;
